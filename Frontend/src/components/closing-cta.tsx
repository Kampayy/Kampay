...
export function ClosingCta() {
  return (
    <section id="waitlist" className="scroll-mt-20 overflow-hidden">
      <Container className="py-16 sm:py-24">
        <div className="relative">
          {/* Pools light behind the conversion card. */}
          <div
            className="card-glow pointer-events-none absolute -inset-8 -z-10 blur-3xl"
            aria-hidden="true"
          />
          ...
          <div className="rounded-2xl border border-line bg-surface px-6 py-12 text-center sm:px-12">
            ...
            <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-pretty text-muted">
              The contracts are written and tested on Soroban. We are looking
              for companies and contributors to run the first payroll cycles on
              testnet.
            </p>
            ...
            <p className="mt-6 text-sm text-faint">
              Pre-audit software. Testnet only — do not use with production
              funds.
            </p>
          </div>
        </div>
